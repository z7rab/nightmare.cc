...
print('[⚙️ Drama; ] Adding Additional UNC.. | Roblox Version: ', version(), ' | Discord Server: https://dsc.gg/getdrama')
...
for _, i in pairs(funcs2) do
 ...
 local str = Result == 1 and ('[⚙️ Drama; ⛔ ] %s already exists.'):format(i) or Result == 2 and ("[⚙️ Drama; ✅ ] Added %s%s to the global environment. (%d/%d)"):format(i, type(v)=='function' and '()' or '', Count, Total) or Result ~= 1 and Result ~= 2 and ("[⚙️ Drama; ⛔ ] Unknown result for %s."):format(i)
 print(str)
end
